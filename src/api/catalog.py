...
def get_catalog():
    ...
    with db.engine.begin() as connection:
        ...
        darkPotions = first_row.num_blue_potions

    potionTypes = {}
    potionTypes['red'] = {'sku':'RED_POTION_0', 'name': 'red potion', 'quantity': redPotions // 2, 'price': 20, 'potion_type': [100, 0, 0, 0]}
    potionTypes['green'] = {'sku': 'GREEN_POTION_0', 'name': 'green_potion', 'quantity': greenPotions // 2, 'price': 20, 'potion_type': [0, 100, 0, 0]}
    potionTypes['blue'] = {'sku': 'BLUE_POTION_0', 'name': 'blue_potion', 'quantity': bluePotions // 2, 'price': 30, 'potion_type': [0, 0, 100, 0]}
    potionTypes['dark'] = {'sku': 'DARK_POTION_0', 'name': 'dark_potion', 'quantity': darkPotions // 2, 'price': 30, 'potion_type': [0, 0, 100, 0]}
